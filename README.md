...
Excalidaw 是一款基于 Excalidraw 打造的 Windows 桌面绘图工具。它保留了 Excalidraw 熟悉的手绘白板体验，同时加入本地优先的 AI 能力，可以 AI 生图，也可以把完整文章生成可继续编辑的 AI 白板讲解长图。
...
- 支持 AI 竖版内容图：粘贴原文 + 选主题，一键生成可编辑的竖版长图，原文零增零减。
- 内置 6 套设计主题（极简黑白、小红书温柔、科技深色、杂志排版、手写草稿、文艺报纸）。
...
进入最新版本页面，下载 `Excalidaw-0.2.18-x64.exe`，双击运行即可使用：
